  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative">
        ...
        {/* Cargo Ship Video Window - Positioned below model selector */}
        <AnimatePresence>
          {showVideo && (
            <motion.div
              ...
              className="absolute left-[360px] bottom-6 z-[5] w-[320px] bg-black/95 backdrop-blur-md border-2 border-cyan-400/40 rounded-lg shadow-2xl overflow-hidden"
            >
              {/* Video Header */}
